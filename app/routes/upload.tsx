...
const Upload:  () => React.JSX.Element = () => {
    ...
    const handleAnalyze = async ({companyName,jobTitle,jobDescription, file}: {companyName: string, jobTitle: string,
        jobDescription: string, file: File}) =>  {
      ...
      <main className="bg-[url('/images/bg-main.svg')]  bg-cover">
        ...
        <section className="main-section">
          <div className={'page-heading py-16'}>
            <h1>Smart Feedback For Four Dream Job</h1>
            {isProcessing ? (
              <>
                <h2>{statusText}</h2>
